...
path = path[:-10] + "/Shared/Scenarios/TestSessionSB2Scenario.yaml"
#print(path)
...
agent.agent.initialise(env,state_space,gamma,alpha,initial_epsilon,final_epsilon,total_steps,num_episodes,double_dqn,dueling_dqn)
