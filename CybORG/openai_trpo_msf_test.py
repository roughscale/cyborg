...
path = path[:-10] + "/Shared/Scenarios/TestMSFSessionTRPOScenario.yaml"
#print(path)
...
agent.agent.initialise(env,gamma=gamma,n_steps=n_steps,batch_size=int(batch_size*n_envs), n_envs=n_envs,normalize_advantage=norm_adv,gae_lambda=gae_lambda,target_kl=target_kl,net_arch=net_arch)
